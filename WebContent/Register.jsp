<jsp:include page="header.jsp"/>
 ...
 <article class="br4 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
      <form  action = "Register"  method = "GET" >
         <p class="f2 b--white grow dim" style="font-family: 'Cabin Sketch', cursive;">Enter First Name:</p> <input class=" notebook f3 bl br2 bw2 br-pill b--white grow" type = "text" name="user" required /><br>
         <br />
