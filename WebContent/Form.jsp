<jsp:include page="header.jsp"/>
   ...
   <div align="center" style="padding-top:10em" class="fl w-100" >
      <form  action = "MyServlet"  method = "GET" >
         <p class="f2 b--white grow dim" style="font-family: 'Cabin Sketch', cursive;">First Name:</p> <input class="notebook f3 bl br2 bw2 br-pill b--white grow" type = "text" name = "firstname" required><br>
         <br/>
