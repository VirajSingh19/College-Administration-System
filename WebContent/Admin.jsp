...
<p align='center' class="f2 b--white grow dim" style="font-family: 'Cabin Sketch', cursive;">Welcome <%=(String)Admin.session.getAttribute("user")%></p>
<button class='f1 dim bw2 br3 grow b--white' onclick="location.href='Form.jsp'"  type='button'  style="font-family: 'Libre Barcode 128 Text', cursive;">Logout</button>
 ...
 <strong>Session id : <%= Admin.session.getId() %> </strong>  
</span>
</body>
</html>
